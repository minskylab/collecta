...
func ID(id xid.ID) predicate.Survey {
...
func IDEQ(id xid.ID) predicate.Survey {
	return predicate.Survey(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id xid.ID) predicate.Survey {
	return predicate.Survey(func(s *sql.Selector) {
...
func IDIn(ids ...xid.ID) predicate.Survey {
	return predicate.Survey(func(s *sql.Selector) {
...
func IDNotIn(ids ...xid.ID) predicate.Survey {
	return predicate.Survey(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id xid.ID) predicate.Survey {
	return predicate.Survey(func(s *sql.Selector) {
...
func IDGTE(id xid.ID) predicate.Survey {
	return predicate.Survey(func(s *sql.Selector) {
...
func IDLT(id xid.ID) predicate.Survey {
	return predicate.Survey(func(s *sql.Selector) {
...
func IDLTE(id xid.ID) predicate.Survey {
	return predicate.Survey(func(s *sql.Selector) {
