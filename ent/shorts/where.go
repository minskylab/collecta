...
func ID(id int) predicate.Shorts {
...
func IDEQ(id int) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
...
func IDLT(id int) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
...
func Value(v uuid.UUID) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
...
func ValueEQ(v uuid.UUID) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldValue), v))
	})
}
...
func ValueNEQ(v uuid.UUID) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
...
func ValueIn(vs ...uuid.UUID) predicate.Shorts {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ValueNotIn(vs ...uuid.UUID) predicate.Shorts {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ValueGT(v uuid.UUID) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
...
func ValueGTE(v uuid.UUID) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
...
func ValueLT(v uuid.UUID) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
...
func ValueLTE(v uuid.UUID) predicate.Shorts {
	return predicate.Shorts(func(s *sql.Selector) {
